...
const medicalPageJsonLd = {
  "@context": "https://schema.org",
  "@type": "MedicalWebPage",
  name: "Проетцин® — инструкция по медицинскому применению",
  description:
    "Подробная инструкция по медицинскому применению препарата Проетцин® (таблетки №60). Показания, противопоказания, дозировка, побочные действия.",
  url: "https://proetsin.uz",
...
const faqJsonLd = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Для чего применяется Проетцин®?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Проетцин® применяется при остром и хроническом синусите (риносинусите), сопровождающемся образованием вязкого секрета. Подходит для взрослых и детей от 6 лет и старше.",
      },
    },
    {
      "@type": "Question",
      name: "Как принимать Проетцин®?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "Продается ли Проетцин® по рецепту?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Нет, препарат Проетцин® отпускается без рецепта.",
      },
    },
    {
      "@type": "Question",
      name: "Можно ли давать Проетцин® детям?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Проетцин® можно давать детям от 6 лет и старше. Для детей в возрасте от 0 до 6 лет безопасность и эффективность не установлены.",
      },
    },
  ],
};
        ...
        <main className="mt-[50px]">
          <article itemScope itemType="https://schema.org/Drug">
            ...
            <h2 className="text-xl md:text-2xl mt-5 text-[#0C54A0] font-semibold font-roboto mb-3">
              ИНСТРУКЦИЯ ПО МЕДИЦИНСКОМУ ПРИМЕНЕНИЮ Проетцин® таблетки №60
            </h2>
            ...
            <div className="text-[14px] md:text-[16px] font-roboto font-light text-justify leading-relaxed max-w-[700px] px-4 md:px-6">
              ...
              <section className="mb-4" aria-label="Форма выпуска и состав">
                <p className="font-roboto text-[14px] md:text-[16px]">
                  <strong className="font-medium">
                    <span className="text-[#0C54A0]">
                      Форма выпуска, упаковка и состав препарата Проетцин®
                    </span>
                  </strong>{" "}
                </p>
              </section>
              ...
              <section className="mb-4" aria-label="Фармакологическое действие">
                ...
                <p className="mt-2 font-medium">
                  Проетцин® оказывает секретолитическое, секретомоторное,
              ...
              <section className="mb-4" aria-label="Особые указания">
                ...
                <p className="mt-2 font-medium">
                  ...
                  Проетцин® с осторожностью, желательно после еды, запивая стаканом
                  воды.
                </p>
                ...
                <p className="font-medium">
                  При применении в рекомендуемых дозах препарат Проетцин® не
